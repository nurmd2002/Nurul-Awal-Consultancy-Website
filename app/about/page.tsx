...
export default function AboutPage() {
  return (
    <main className="bg-[#fbf7ef]">
      ...
      <section className="relative overflow-hidden bg-[#063f24] px-8 py-32 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] text-center">
          <div className="mx-auto mb-7 flex w-80 items-center justify-center gap-5">
            <span className="h-px flex-1 bg-[#d8b75b]" />
            <span className="h-3 w-3 rotate-45 bg-[#d8b75b]" />
            <span className="h-px flex-1 bg-[#d8b75b]" />
          </div>

          <p className="font-serif text-xl font-bold uppercase tracking-[0.18em] text-[#d8b75b]">
            About Nurul-Awal
          </p>

          <h1 className="mx-auto mt-7 max-w-5xl font-serif text-7xl leading-tight">
          ...
          <Link
            href="/contact"
            className="group mt-10 inline-flex items-center rounded-md border-2 border-[#d8b75b] bg-white px-10 py-5 font-serif text-lg font-bold text-[#177D3F] transition hover:-translate-y-1"
          >
            Enquire Now
    ...
    />
      ...
      <section id="vision-mission" className="relative bg-[#f3f8f1] px-8 py-20">
        <div className="mx-auto grid max-w-[1280px] gap-8 lg:grid-cols-2">
          <div className="rounded-[30px] border border-[#d8b75b]/35 bg-white p-10 shadow-sm">
            ...
            <h3 className="font-serif text-5xl text-[#177D3F]">Our Vision</h3>
          ...
          <div className="rounded-[30px] border border-[#d8b75b]/35 bg-white p-10 shadow-sm">
            ...
            <h3 className="font-serif text-5xl text-[#177D3F]">Our Mission</h3>
            <p className="mt-6 text-lg leading-9 text-neutral-700">
      ...
      <section className="px-8 py-20">
        <div className="mx-auto max-w-[1280px] text-center">
          <p className="font-serif text-xl font-bold uppercase tracking-[0.12em] text-[#177D3F]">
          ...
          <div className="mt-10 grid gap-7 md:grid-cols-2 lg:grid-cols-4">
            {whyChoose.map((item) => (
              <div
                key={item.title}
                className="rounded-[28px] border border-[#d8b75b]/35 bg-white p-9 shadow-sm transition hover:-translate-y-2 hover:shadow-xl"
              >
      ...
      <section className="bg-[#fbf7ef] px-8 py-20">
        <div className="mx-auto grid max-w-[1280px] items-start gap-16 lg:grid-cols-2">
          <div id="core-values" className="w-full">
            ...
            <div className="grid grid-cols-1 overflow-hidden rounded-[32px] border border-[#d8b75b]/40 bg-white md:grid-cols-2">
              {values.map((value) => (
                <div
                  key={value.title}
                  className="border-b border-r border-[#d8b75b]/30 p-10 text-center last:border-b-0"
                >
          ...
          <div id="our-journey" className="w-full">
            ...
            <div className="relative mt-5 pl-20">
              <div className="absolute bottom-8 left-9 top-5 w-[4px] bg-[#063f24]" />

              <div className="space-y-10">
                {journey.map((item) => (
                  <div key={item.title} className="relative">
                    <div className="absolute -left-[92px] top-0 flex h-20 w-20 items-center justify-center rounded-full border-[8px] border-[#b7d5ae] bg-[#063f24] shadow-md">
                      <item.Icon className="h-11 w-11 text-white" strokeWidth={1.8} />
                    </div>

                    <h3 className="font-serif text-3xl font-bold text-[#177D3F]">
                      {item.title}{" "}
                      <span className="text-[#177D3F]">({item.year})</span>
                    </h3>

                    <p className="mt-3 text-xl leading-9 text-black">
                      {item.text}
                    </p>
                  </div>
                ))}
      ...
      <section className="relative overflow-hidden bg-[#fbf7ef] px-8 py-20">
        ...
        <div className="relative z-10 mx-auto max-w-[1320px]">
          <div className="relative overflow-hidden rounded-[42px] border border-[#d8b75b]/80 bg-gradient-to-br from-[#064727] via-[#07582f] to-[#04351f] px-10 py-20 text-center text-white shadow-[0_30px_90px_rgba(0,0,0,0.25)]">
            ...
            <div className="relative z-10 mx-auto mb-8 flex w-72 items-center justify-center gap-5">
              <span className="h-px flex-1 bg-[#d8b75b]" />
            ...
            <div className="relative z-10 mx-auto max-w-5xl">
              <p className="font-serif text-3xl text-[#d8b75b]">
                Ready to Work Together?
              </p>

              <h2 className="mx-auto mt-7 max-w-5xl font-serif text-6xl leading-tight text-white drop-shadow-md md:text-7xl">
                Let us simplify your halal
                <br />
                certification journey.
              </h2>

              <p className="mx-auto mt-7 max-w-2xl text-2xl leading-10 text-white/90">
              ...
              <Link
                href="/contact"
                className="group mt-12 inline-flex items-center gap-6 rounded-lg border-2 border-[#d8b75b] bg-white px-14 py-5 font-serif text-xl font-bold uppercase tracking-wide text-[#063f24] shadow-lg transition hover:-translate-y-1 hover:bg-[#fffaf0]"
              >
